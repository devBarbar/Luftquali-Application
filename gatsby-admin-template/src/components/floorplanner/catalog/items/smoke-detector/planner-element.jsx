...
function makeObjectMaxLOD() {
  ...
  for (let i = 0; i < Math.PI * 4; i += (4 * Math.PI) / 3) {
    let geometry = new Three.TorusGeometry(0.45, 0.025, 32, 100, Math.PI / 3);
    ...
    let geometry2 = new Three.TorusGeometry(0.35, 0.025, 32, 100, Math.PI / 3);
    ...
    let geometry3 = new Three.TorusGeometry(0.25, 0.025, 32, 100, Math.PI / 3);
